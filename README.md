...
**B2B（biz flavor）: 無料ティアなし。トライアルなし。**

| プラン | 月額 | 年額 | ワーカー数 | 主な機能 | 状態 |
|--------|------|------|-----------|---------|------|
| **ライト** | ¥3,000 | ¥29,800 | 10 人 | WBGT 監視 + アラート + 記録保存 + CSV | ✅ v1.0 提供中 |
...
| Phase | 内容 | ターゲット |
|-------|------|-----------|
| **Phase 1 (v1.0)** | ライトプランのみ販売。Paywall は単一プラン表示。 | 10人以下の小規模建設業 |
| **Phase 2 (v1.1)** | BLE センサー連携 + スタンダード解禁 | 中規模現場（〜50人） |
| **Phase 3 (v1.2)** | チーム管理・API 連携 + エンタープライズ解禁 | 大手建設・製造業 |
